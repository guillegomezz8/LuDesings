...
class PedidoAdmin(admin.ModelAdmin):
    list_display = ('id', 'nombre_cliente', 'email', 'estado', 'estado_pago', 'stock_reservado', 'total', 'fecha_creacion')
    list_filter = ('estado', 'estado_pago', 'stock_reservado', 'fecha_creacion')
