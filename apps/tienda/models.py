...
class Pedido(models.Model):
    ...
    stock_reservado = models.BooleanField('stock reservado', default=False)
    fecha_expiracion_pago = models.DateTimeField('fin de la reserva de stock', null=True, blank=True)
